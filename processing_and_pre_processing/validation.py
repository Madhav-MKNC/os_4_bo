...
lang_codes = {
    ...
    'marathi': 'MH', 'gujarati': 'GJ',
    'punjabi': 'PB', 'panjabi': 'PB',
...
order = [
    "*Order Id", "Order Date as dd-mm-yyyy hh:MM", "*Channel",
    "*Payment Method(COD/Prepaid)", "*Customer First Name",
    "Customer Last Name", "Email (Optional)",
    "*Customer Mobile", "Customer Alternate Mobile",
    "*Shipping Address Line 1", "Shipping Address Line 2",
    "*Shipping Address Country", "*Shipping Address State",
    "*Shipping Address City", "*Shipping Address Postcode",
    "Billing Address Line 1", "Billing Address Line 2",
    "Billing Address Country", "Billing Address State",
    "Billing Address City", "Billing Address Postcode",
    "*Master SKU", "*Product Name", "*Product Quantity",
    "Tax %", "*Selling Price(Per Unit Item, Inclusive of Tax)",
    "Discount(Per Unit Item)", "Shipping Charges(Per Order)",
    "COD Charges(Per Order)", "Gift Wrap Charges(Per Order)",
    "Total Discount (Per Order)", "*Partial COD (Yes/No)",
    "*Length (cm)", "*Breadth (cm)", "*Height (cm)",
    "*Weight Of Shipment(kg)", "Send Notification(True/False)",
    "Comment", "HSN Code", "Location Id", "Reseller Name",
    "Company Name", "latitude", "longitude", "Verified Order",
    "Is documents", "Order Type", "Order tag",
]
